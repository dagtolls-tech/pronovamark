  ...
  return (
    <section id="datos" className="bg-brand-black pt-20 lg:pt-28 pb-12 lg:pb-14 relative overflow-hidden" aria-labelledby="stats-heading">
      ...
      <div className="relative max-w-container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedGroup className="grid grid-cols-2 gap-y-10 gap-x-8 sm:gap-x-14 lg:flex lg:justify-between lg:gap-x-6 border-t border-white/10 pt-12" stagger={0.1}>
          {STATS.map((stat) => (
